"""
Django settings for workshop_prj project.
...
ROOT_URLCONF = 'workshop_prj.urls'
...
WSGI_APPLICATION = 'workshop_prj.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # 이미지 등의 미디어 파일을 저장할 경로